...
- [Color Spark](https://colorspark.app/) - single color/gradient inspiration

- [Color Box](https://www.colorbox.io/)

:heavy_minus_sign: __Gradients:__
...
- [Humane by Design](https://humanebydesign.com/) - design best practices
...
- [Designing Mindfulness](https://www.designingmindfulness.com/#home/designing-mindfulness)
...
* :pushpin:[geddski](https://gedd.ski/) - creator of flexbox zombies & other games, articles about css, ui, etc
...
- [Advent of Code](https://www.taniarascia.com/how-to-create-a-memory-game-super-mario-with-plain-javascript/)
...
* [Defining a Modular Type Scale for a web UI](https://blog.prototypr.io/defining-a-modular-type-scale-for-web-ui-51acd5df31aa)

- [SuperHi tutorials](https://www.superhi.com/video) - video and tutorials section, superhi has paid courses on development with design

- [Little Snippets](https://www.littlesnippets.net/) - code snippets

- [CSS Code Snippets](http://www.cssflow.com/snippets)

- [Code my UI](https://codemyui.com/)

- [Mobile web problems and how to avoid them](http://bradfrost.com/blog/post/mobile-web-problems/)

- [This is Responsive](https://bradfrost.github.io/this-is-responsive/) - pattens and resources for creating responsive web experiences

- [Simple does not mean ugly](https://bradleytaunt.com/simple-does-not-mean-ugly)

- [Accssible](https://accssible.com/) - writing about CSS and design, tutorials and articles

- :star: [My 8 tips & tricks for UI development](https://stories.justinewin.com/my-8-tips-tricks-in-ui-development-aefc5b89f469)

- :star: [UI practices that work all the time](https://stories.justinewin.com/ui-practices-that-work-all-the-time-1eb9a6063de0)

- [Pintab](http://pintab.co/index) - design and development resource list
...
- :pushpin: [Smashing Magazine](https://www.smashingmagazine.com/articles/) - Articles on everything web dev and design

- :pushpin: [A List Appart](https://alistapart.com/)

- [Code Talks](https://codetalks.tv/) - last talks about development

- [Coderwall](https://coderwall.com/) - reddit for coders

-----------------------------------------------------
### :small_blue_diamond: Code Examples
...
- [How to optimize your GitHub portfolio](https://hackernoon.com/how-to-optimize-your-github-profile-9540f338b2c9)
...
------------------------------------------------------
### :small_blue_diamond: Collaboration Projects
...
-------------------------------------------------
### :small_blue_diamond: Work

- [User Testers](https://usertesters.io) - earn money testing websites

- :book: [Guide to Freelancing](https://www.hellobonsai.com/ebooks/bonsai-invision-freelance-guide) - by Bonsai and InVision

- [Women Who Design](https://womenwho.design/) - job board and design ladies to follow

- [Toptal](https://www.toptal.com/)

- [We Work Remotely](https://weworkremotely.com/)

- [Remote friendly companies list](https://github.com/remoteintech/remote-jobs)

- [RemoteHub](https://remotehub.io/)

- [Remotive](https://remotive.io/)

- [Job Fluent](https://www.jobfluent.com/)
...
---------------------------------------------------
### :small_blue_diamond: SEO

- [Buildvisible](https://builtvisible.com/resources/) - blog and resources about SEO mostly

- [Begginers guide to SEO](https://moz.com/beginners-guide-to-seo)

---------------------------------------------
### :small_blue_diamond: Commerce
